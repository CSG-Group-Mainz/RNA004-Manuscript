...
###subset pod5 of A file and convert to fast5 for the legacy basecallers
...
##pod5 filter ./RESEARCH/20230714_Lemke_DRS_RNA002_B_Run2/Sample_B/20230714_1506_2B_PAG68254_d732e056/pod5/*.pod5 --output ./chr20_rna002_lemke_b_pod5/chr20_rna002_lemke_b.filtered.pod5 --ids read_idsB.txt --missing-ok
...
##pod5 filter ./RESEARCH/20230714_UHRR_R9_DRS/UHRR_R9_DRS/20230714_1508_3A_PAG68321_9f572de7/pod5/*.pod5 --output ./chr20_rna002_uhrr_pod5/chr20_rna002_uhrr_pod5.filtered.pod5 --ids read_idsUHRR.txt --missing-ok
...
#echo "start rna002 blood"
#mkdir -p ./chr20_rna002_blood_pod5/
#samtools view RNA002_blood.0.7.2.GRCh38.chr20.bam | cut -f1 | sort -u >read_idsblood.txt
#pod5 filter ./RNA004_Manuscript_reanalysis/TEST_folder/pod5_convert_blood_RNA002/*.pod5 --output ./chr20_rna002_blood_pod5/chr20_rna002_blood.filtered.pod5 --ids read_idsblood.txt --missing-ok
#mkdir -p chr20_rna002_blood_fast5
#pod5 convert to_fast5 ./chr20_rna002_blood_pod5/chr20_rna002_blood.filtered.pod5 --output ./chr20_rna002_blood_fast5

#echo "start blood_IVT"
#mkdir -p ./chr20_rna002_blood_IVT_pod5/
#samtools view RNA002_blood_IVT.0.7.2.GRCh38.chr20.bam | cut -f1 | sort -u >read_idsblood_ivt.txt
#pod5 filter ./RNA004_Manuscript_reanalysis/TEST_folder/pod5_convert_blood_RNA002_IVT/*.pod5 --output ./chr20_rna002_blood_IVT_pod5/chr20_rna002_blood_IVT_pod5.filtered.pod5 --ids read_idsblood_ivt.txt --missing-ok
#mkdir -p ./chr20_rna002_blood_IVT_fast5
#pod5 convert to_fast5 ./chr20_rna002_blood_IVT_pod5/chr20_rna002_blood_IVT_pod5.filtered.pod5 --output ./chr20_rna002_blood_IVT_fast5
