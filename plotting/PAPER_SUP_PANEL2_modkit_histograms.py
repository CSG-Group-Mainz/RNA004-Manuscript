...
HEK_A_m6A = modkitHIST(file="hist_dirs/hist_dirRNA004_A_basecall.0.7.2.GRCh38/",
                       modification="a", color="#CD7D66", outpath="SUPP_FIG_2_A_HEK_A_m6a.pdf", title="HEK293T_A m6A")

HEK_A_pseu = modkitHIST(file="hist_dirs/hist_dirRNA004_A_basecall.0.7.2.GRCh38/",
                       modification="17802", color="#CD7D66", outpath="SUPP_FIG_2_B__HEK_A_pseu.pdf", title="HEK293T_A pseU")

HEK_B_m6A = modkitHIST(file="hist_dirs/hist_dirRNA004_B_basecall.0.7.2.GRCh38/",
                       modification="a", color="#CD7D66", outpath="SUPP_FIG_2_C_HEK_B_m6a.pdf", title="HEK293T_B m6A")

HEK_B_pseu = modkitHIST(file="hist_dirs/hist_dirRNA004_B_basecall.0.7.2.GRCh38/",
                       modification="17802", color="#CD7D66", outpath="SUPP_FIG_2_D_HEK_B_pseu.pdf", title="HEK293T_B pseU")


###### BLOOD

Blood_1_m6A = modkitHIST(file="hist_dirs/hist_dirRNA004_blood.0.7.2.GRCh38/",
                       modification="a", color="#0B3954", outpath="SUPP_FIG_2_E_Blood_1_m6a.pdf", title="Blood_1 m6A")

Blood_1_pseu = modkitHIST(file="hist_dirs/hist_dirRNA004_blood.0.7.2.GRCh38/",
                       modification="17802", color="#0B3954", outpath="SUPP_FIG_2_F_Blood_1_pseu.pdf", title="Blood 1 pseU")

Blood_2_m6A = modkitHIST(file="hist_dirs/hist_dirRNA004_S5_DRS_basecall.0.7.2.GRCh38/",
                       modification="a", color="#0B3954", outpath="SUPP_FIG_2_G_Blood_2_m6a.pdf", title="Blood_2 m6A")

Blood_2_pseu = modkitHIST(file="hist_dirs/hist_dirRNA004_S5_DRS_basecall.0.7.2.GRCh38/",
                       modification="17802", color="#0B3954", outpath="SUPP_FIG_2_H_Blood_2_pseu.pdf", title="Blood_2 pseU")

Blood_3_m6A = modkitHIST(file="hist_dirs/hist_dirRNA004_S6_DRS_basecall.0.7.2.GRCh38/",
                       modification="a", color="#0B3954", outpath="SUPP_FIG_2_I_Blood_3_m6a.pdf", title="Blood_3 m6A")

Blood_3_pseu = modkitHIST(file="hist_dirs/hist_dirRNA004_S6_DRS_basecall.0.7.2.GRCh38/",
                       modification="17802", color="#0B3954", outpath="SUPP_FIG_2_J_Blood_3_pseu.pdf", title="Blood_3 pseU")

Blood_IVT_m6A = modkitHIST(file="hist_dirs/hist_dirmerged_RNA004_S6_IVT/",
                       modification="a", color="#098C9A", outpath="SUPP_FIG_2_K_Blood_IVT_m6A.pdf", title="Blood_IVT m6A")

Blood_IVT_pseu = modkitHIST(file="hist_dirs/hist_dirmerged_RNA004_S6_IVT/",
                       modification="17802", color="#098C9A", outpath="SUPP_FIG_2_L_Blood_IVT_pseu.pdf", title="Blood_IVT pseU")
